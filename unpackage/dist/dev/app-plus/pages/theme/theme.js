...
/******/ 	return __webpack_require__(__webpack_require__.s = "F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue?entry");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/weex-vue-loader/lib/script-loader.js!./node_modules/babel-loader/lib/index.js!./node_modules/weex-vue-loader/lib/selector.js?type=script&index=0!F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/weex-vue-loader/lib/script-loader.js!./node_modules/babel-loader/lib!./node_modules/weex-vue-loader/lib/selector.js?type=script&index=0!F:/www/zhanghuai/盘子App/pages/theme/theme.nvue ***!
  \************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./index */ "F:\\www\\zhanghuai\\盘子App\\pages\\theme\\index.js"));
var _tabbar = _interopRequireDefault(__webpack_require__(/*! @/components/tab-nvue/tabbar.nvue */ "F:\\www\\zhanghuai\\盘子App\\components\\tab-nvue\\tabbar.nvue"));
...
var domModule = weex.requireModule('dom');var _default = { /**
                                                            * 大部分js可以复用vue中写的
                                                            * 直接混入即可
                                                            */mixins: [_index.default], components: { uniTabBar: _tabbar.default }, data: function data() {return { dataList: [] };}, beforeCreate: function beforeCreate() {domModule.addRule('fontFace', { 'fontFamily': "iconfont", 'src': "url('https://at.alicdn.com/t/font_1209399_vkkyf5au3ui.ttf')" });}, created: function created() {//获取数据，方法通过mixin混入
    this.loadTabbars();this.dataList = _Json.default.themeList;}, mounted: function mounted() {uni.getStorage({ key: 'token', fail: function fail() {(0, _common.createTabView)();} });}, methods: { switchTabs: function switchTabs(event, index) {this.tabCurrentIndex = index;var target = event.target;if (plus.os.name == 'Android') {domModule.scrollToElement(target, { offset: -300 });} //第一次切换tab，动画结束后需要加载数据
      var tabItem = this.tabBars[this.tabCurrentIndex];

      var list = _Json.default.themeList;
    ...
    // 查看详情
    seeThemeInfo: function seeThemeInfo() {
      uni.navigateTo({
...
/***/ "./node_modules/weex-vue-loader/lib/style-loader.js!./node_modules/weex-vue-loader/lib/style-rewriter.js?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector.js?type=styles&index=0!F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue":
/*!***************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/weex-vue-loader/lib/style-loader.js!./node_modules/weex-vue-loader/lib/style-rewriter.js?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector.js?type=styles&index=0!F:/www/zhanghuai/盘子App/pages/theme/theme.nvue ***!
  \***************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/weex-vue-loader/lib/template-compiler.js?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector.js?type=template&index=0!F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue":
/*!*****************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/weex-vue-loader/lib/template-compiler.js?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector.js?type=template&index=0!F:/www/zhanghuai/盘子App/pages/theme/theme.nvue ***!
  \*****************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          _vm.switchTabs($event, index)
        }
      }
    }, [_c('text', {
      staticClass: ["text"],
      class: [_vm.tabCurrentIndex == index ? 'active' : '']
    ...
    return _c('cell', {
      ...
      staticClass: ["theme-name-text"]
    }, [_vm._v(_vm._s(item.name))])]), _c('div', {
      staticClass: ["theme-right"]
    }, [(!item.love) ? _c('image', {
      staticClass: ["love"],
      attrs: {
      ...
      staticClass: ["love-active"],
      attrs: {
        "src": "../../static/images/love-active.png"
      }
    }), _c('text', {
      staticClass: ["love-text", "margin-left-5"]
    }, [_vm._v(_vm._s(item.loveNum))]), _c('image', {
      staticClass: ["see"],
      attrs: {
        "src": "../../static/images/theme-see-icon.png"
      }
    }), _c('text', {
      staticClass: ["see-text", "margin-left-5"]
    }, [_vm._v(_vm._s(item.see))])])])])])
  }), _c('loading', {
    staticClass: ["loading"],
    attrs: {
      "display": _vm.tabBars[_vm.tabCurrentIndex].loadMoreStatus == 1 ? 'show' : 'hide'
    },
    on: {
      "loading": _vm.loadThemeList
    }
  }, [_c('loading-indicator', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.tabBars[_vm.tabCurrentIndex].loadMoreStatus == 1),
      expression: "tabBars[tabCurrentIndex].loadMoreStatus == 1"
    }],
    staticClass: ["loading-icon"]
  }), _c('text', {
    staticClass: ["loading-text"]
  }, [_vm._v(_vm._s(_vm.tabBars[_vm.tabCurrentIndex].loadMoreStatus == 0 ? '上拉显示更多' : _vm.tabBars[_vm.tabCurrentIndex].loadMoreStatus == 1 ? '正在加载..' : '没有更多数据了'))])])], 2)])
  ...
  return _c('cell', {
    ...
    staticClass: ["theme-banner"],
    attrs: {
      "resize": "cover",
      "src": "../../static/img/them-banner.jpg"
    }
  })])
}]}
...
/***/ "F:\\www\\zhanghuai\\盘子App\\pages\\theme\\index.js":
/*!***************************************************!*\
  !*** F:/www/zhanghuai/盘子App/pages/theme/index.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _Json = _interopRequireDefault(__webpack_require__(/*! @/Json */ "F:\\www\\zhanghuai\\盘子App\\Json.js"));
...
Vue.prototype.$uniSkip = _uniSkip.default;var _default =
{
  ...
  methods: {
    loadTabbars: function loadTabbars() {
      var tabList = _Json.default.themeTab;
    ...
    //新闻列表
    loadThemeList: function loadThemeList(type) {
      var tabItem = this.tabBars[this.tabCurrentIndex];
    ...
    navToDetails: function navToDetails(item) {
      ...
      console.log(555, data.images, " at pages\\theme\\index.js:61");
    ...
    // 预览图片
    previewImageHandler: function previewImageHandler(index) {

    } } };exports.default = _default;

/***/ }),

/***/ "F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue?entry":
/*!***********************************************************!*\
  !*** F:/www/zhanghuai/盘子App/pages/theme/theme.nvue?entry ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* styles */
__vue_styles__.push(__webpack_require__(/*! !./node_modules/weex-vue-loader/lib/style-loader!./node_modules/weex-vue-loader/lib/style-rewriter?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector?type=styles&index=0!./theme.nvue */ "./node_modules/weex-vue-loader/lib/style-loader.js!./node_modules/weex-vue-loader/lib/style-rewriter.js?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector.js?type=styles&index=0!F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue")
)

/* script */
__vue_exports__ = __webpack_require__(/*! !./node_modules/weex-vue-loader/lib/script-loader!babel-loader!./node_modules/weex-vue-loader/lib/selector?type=script&index=0!./theme.nvue */ "./node_modules/weex-vue-loader/lib/script-loader.js!./node_modules/babel-loader/lib/index.js!./node_modules/weex-vue-loader/lib/selector.js?type=script&index=0!F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue")

/* template */
var __vue_template__ = __webpack_require__(/*! !./node_modules/weex-vue-loader/lib/template-compiler?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector?type=template&index=0!./theme.nvue */ "./node_modules/weex-vue-loader/lib/template-compiler.js?id=data-v-40c963e6!./node_modules/weex-vue-loader/lib/selector.js?type=template&index=0!F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue")
__vue_options__ = __vue_exports__ = __vue_exports__ || {}
if (
  typeof __vue_exports__.default === "object" ||
  typeof __vue_exports__.default === "function"
...
__vue_options__.__file = "F:\\www\\zhanghuai\\盘子App\\pages\\theme\\theme.nvue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-40c963e6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
